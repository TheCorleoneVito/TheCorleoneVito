...
addEventHandler("faction-system.saveNewRank", root, 
	function(playerName, oldRank, newRank, factionID)
		...
		--local plrRank2 = tonumber(getPlayerFactionRank(client))
		--local oldRank2 = tonumber(getFactionRankIDByName(fID, oldRank))
		--local newRank2 = tonumber(getFactionRankIDByName(fID, newRank))
		...
		--if ( newRank > plrRank ) then
		--outputChatBox("Goh Mikhori Mikhay Rank Balatar be khodet bedi _|_", 255, 125, 0)
		--return
		--end
